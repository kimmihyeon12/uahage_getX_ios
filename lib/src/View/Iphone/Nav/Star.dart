  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
          ...
          appBar: x_imageAppbar(context, "즐겨찾기"),
          body: Obx(() => (() {
                  ...
                  return Column(
                    ...
                    children: [
                      Container(
                        ...
                        margin: EdgeInsets.only(top: 746.h * 0.62 * 0.9),
                        child: Image.asset(
                          './assets/starPage/group.png',
                          height: 400.h * 0.62 * 0.9,
                          width: 700.w * 0.7 * 0.84,
                        ),
                      ),
                    ],
                  );
                              ...
                              child: Row(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    child: Container(
                                      width: 1150.w * 0.7 * 0.84,
                                      //     color:Colors.pink,
                                      margin: EdgeInsets.only(top: 15.h * 0.62),
                                      child: Row(
                                        crossAxisAlignment:
                                        ...
                                        children: [
                                          (() {
                                            if (index % 4 == 1) {
                                              return Image.asset(
                                                listimage[0],
                                                height: 370.w * 0.7 * 0.84,
                                                width: 370.w * 0.7 * 0.84,
                                              );
                                            } else if (index % 4 == 2) {
                                              return Image.asset(
                                                listimage[1],
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                margin: EdgeInsets.only(
                                                    top: 10.h * 0.62 * 0.9),
                                                height: 120.h * 0.62 * 0.9,
                                                width: 650.w * 0.7 * 0.84,
                                                alignment:
