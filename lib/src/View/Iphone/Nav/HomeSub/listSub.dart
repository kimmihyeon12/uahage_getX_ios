        ...
        child: Scaffold(
          ...
          appBar: (() {
            if (placeCode == 1)
              ...
              return x_appBar(context, data.name, "");
          }()),
          body: Stack(
            children: [
              ListView(
                      ...
                      Column(
                        ...
                        children: [
                          Column(
                            children: [
                              Container(
                                width: 1500.w * 0.7 * 0.75,
                                child: (() {
                                  if (placeCode == 1) {
                                    if (index % 3 == 1) {
                                      return mainImage(restaurantListImage[0],
                                          1500.w * 0.7 * 0.75);
                                    } else if (index % 3 == 2) {
                                      return mainImage(restaurantListImage[1],
                                          1500.w * 0.7 * 0.75);
                                    } else
                                      return mainImage(restaurantListImage[2],
                                          1500.w * 0.7 * 0.75);
                                  } else if (placeCode == 2) {
                                    if (index % 2 == 1)
                                      return mainImage(hospitalListImage[0],
                                          1500.w * 0.7 * 0.75);
                                    else
                                      return mainImage(hospitalListImage[1],
                                          1500.w * 0.7 * 0.75);
                                  } else if (placeCode == 5) {
                                    if (index % 2 == 1)
                                      return mainImage(kidsCafeListImage[0],
                                          1500.w * 0.7 * 0.75);
                                    else
                                      return mainImage(kidsCafeListImage[1],
                                          1500.w * 0.7 * 0.75);
                                  } else if (placeCode == 8) {
                                    if (data.image_path == null) {
                                      return mainImage(experienceListImage[0],
                                          1500.w * 0.7 * 0.75);
                                    } else {
                                      return Container(
                                        color: Colors.black,
                                        child: SizedBox(
                                          height: 870.w * 0.7 * 0.75,
                                    ...
                                    if (index % 4 == 1)
                                      ...
                                      return mainImage(experienceListImage[1],
                                          1500.w * 0.7 * 0.75);
                                    else if (index % 4 == 3)
                                      return mainImage(experienceListImage[2],
                                          1500.w * 0.7 * 0.75);
                                    else
                                      return mainImage(experienceListImage[3],
                                          1500.w * 0.7 * 0.75);
                                  }
                                }()),
                              ),
                              ...
                              child: Column(
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Container(
                                        width: 1230.w * 0.7 * 0.75,
                                        child: boldfont(
                                            data.name, 43, Colors.black),
                                      ),
                                      Padding(
                                        padding: EdgeInsets.only(
                                            //     left: 20.w * 0.7 * 0.75,
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  normalfont("주소", 32, Color(0xff4d4d4d)),
                                  Padding(
                                      padding: EdgeInsets.only(
                                          top: 10.w * 0.7 * 0.75)),
                                  Row(
                                    ...
                                    children: [
                                      Container(
                                        width: 965.w * 0.7 * 0.75,
                                        child: normalfont("${data.address}", 32,
                                            Color(0xff808080)),
                                      ),
                                      Padding(
                                          padding: EdgeInsets.only(
                                        ...
                                        child: Row(
                                          children: [
                                            Image.asset(
                                              ...
                                              width: 250.w * 0.7 * 0.75,
                                              height: 56.h * 0.62 * 0.779,
                                            ),
                                          ],
                                        ),
                                        onTap: () {
                                  ...
                                  Padding(
                                      padding: EdgeInsets.only(
                                          top: 30.w * 0.7 * 0.75)),
                                  normalfont("연락처", 32, Color(0xff4d4d4d)),
                                  Padding(
                                      padding: EdgeInsets.only(
                                    top: 10.w * 0.7 * 0.75,
                                  )),
                                  Row(
                                    ...
                                    children: [
                                      Container(
                                        width: 955.w * 0.7 * 0.75,
                                        child: normalfont("${data.phone}", 32,
                                            Color(0xff808080)),
                                      ),
                                      Padding(
                                          padding: EdgeInsets.only(
                                  ...
                                  // placeCode == 1
                                  //     ? Padding(
                                  //         padding: EdgeInsets.only(top: 30.w*0.7*0.75))
                                  //     : Padding(
                                  //         padding: EdgeInsets.only(top: 0.w*0.7*0.75)),
                                  // placeCode == 1
                                  //     ? normalfont("영업시간", 32, Color(0xff4d4d4d))
                                  //     : Container(),
                                  // placeCode == 1
                                  //     ? Padding(
                                  //         padding: EdgeInsets.only(top: 10.w*0.7*0.75))
                                  //     : Padding(
                                  //         padding: EdgeInsets.only(top: 0.w*0.7*0.75)),
                                  // placeCode == 1
                                  //     ? Container(
                                  //         width: 500 * width.w*0.7*0.75,
                                  //         child: normalfont(
                          ...
                          //             children: [
                          //               Padding(
                          //                   padding: EdgeInsets.only(top: 30.h*0.62*0.779)),
                          //               normalfont("매장정보", 32, Color(0xff4d4d4d)),
                          //               Padding(
                          //                   padding: EdgeInsets.only(top: 6.h*0.62*0.779)),
                          //               Row(
                          //                 children: [
                          //                   Container(
                          //                     width: 530.w*0.7*0.75,
                          //                     child: normalfont("OO 평일런치", 32,
                          //                         Color(0xff808080)),
                          //                   ),
                          //                   Container(
                          //                     child: normalfont("15,900원", 32,
                          //                         Color(0xffc6c6c6)),
                          //                   ),
                          //                 ],
                          //               ),
                          ...
                          //                   Container(
                          //                     width: 530.w*0.7*0.75,
                          //                     child: normalfont("OO 평일디너", 32,
                          //                         Color(0xff808080)),
                          //                   ),
                          //                   Container(
                          //                     child: normalfont("22,900원", 32,
                          //                         Color(0xffc6c6c6)),
                          //                   ),
                          //                 ],
                          //               ),
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    crossAxisAlignment:
                                        CrossAxisAlignment.start,
                                    children: [
                                      normalfont("검진항목", 32, Color(0xff4d4d4d)),
                                      Padding(
                                          padding: EdgeInsets.only(
                                              top: 10.h * 0.62 * 0.779)),
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    crossAxisAlignment:
                                        CrossAxisAlignment.start,
                                    children: [
                                      normalfont("정보", 32, Color(0xff4d4d4d)),
                                      Padding(
                                          padding: EdgeInsets.only(
                                              top: 10.h * 0.62 * 0.779)),
                                      normalfont(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                          padding: EdgeInsets.only(
                                              top: 30.h * 0.62 * 0.779)),
                                      normalfont("홈페이지", 32, Color(0xff4d4d4d)),
                                      Padding(
                                          padding: EdgeInsets.only(
                                              top: 10.h * 0.62 * 0.779)),
                                      InkWell(
                              ...
                              return Container(
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      normalfont(
                                          "관람 / 체험료", 32, Color(0xff4d4d4d)),
                                      Padding(
                                          padding: EdgeInsets.only(
                                              top: 10.h * 0.62 * 0.779)),
                                      normalfont("${data.admission_fee}", 32,
                                          Color(0xff808080)),
                                      Padding(
                                          padding: EdgeInsets.only(
                                              top: 50.h * 0.62 * 0.779)),
                          ...
                          InkWell(
                            ...
                            child: Container(
                              child: Container(
                                height: 200.h * 0.62 * 0.779,
                                child: Center(
                                  child: Image.asset(
                                    "./assets/sublistPage/modify.png",
                                    height: 90.h * 0.62 * 0.779,
                                  ),
                                ),
                              ),
                            ),
                          ...
                          placeCode == 2
                              ? Container(
                                  margin: EdgeInsets.only(
                                      top: 36 * height.h * 0.62 * 0.779,
                                      left: 35 * width.w * 0.7 * 0.75,
                                      right: 35 * width.w * 0.7 * 0.75,
                                      bottom: 253 * height.h * 0.62 * 0.779),
                                  padding:
                                      EdgeInsets.all(18 * width.w * 0.7 * 0.75),
                          ...
                          placeCode == 1
                              ? Container(
                                  margin: EdgeInsets.only(
                                      left: 36 * width.w * 0.7 * 0.75,
                                      top: 36 * width.h * 0.62 * 0.779),
                                  child: Stack(
                                    children: [
                                      Container(
                                          decoration: BoxDecoration(
                                              ...
                                              borderRadius: BorderRadius.all(
                                                  Radius.circular(20))),
                                          height: 193 * height.h * 0.62 * 0.779,
                                          width: 648 * width.w * 0.7 * 0.75),
                                      score.length > 0
                                          ? Container(
                                              margin: EdgeInsets.only(
                                                  top: 20.h * 0.62 * 0.779),
                          ...
                          placeCode == 1
                              ? Padding(
                                  padding: EdgeInsets.only(
                                      top: 36 * width.w * 0.7 * 0.75))
                              : Padding(
                                  padding: EdgeInsets.only(
                                      top: 0 * width.w * 0.7 * 0.75)),
                          ...
                          placeCode == 1
                              ? Container(
                                  // height: 20.h*0.62*0.779,
                                  width: double.infinity,
                                  child: Row(
                                    children: [
                                      Padding(
                                          padding: EdgeInsets.only(
                                              top: 80 * height.h * 0.62 * 0.779,
                                              left: 35 * width.w * 0.7 * 0.75)),
                                      normalfont("리뷰 ", 32, Color(0xff4d4d4d)),
              ...
              Container(
                margin: EdgeInsets.only(
                    left: 1150.w * 0.7 * 0.75, top: 2100.h * 0.62 * 0.779),
                child: InkWell(
                  onTap: () {
                    _scrollController.jumpTo(1);
                  },
                  child: Image.asset("./assets/sublistPage/top.png",
                      width: 350.w * 0.7 * 0.75),
                ),
              ),
            ],
          ),
