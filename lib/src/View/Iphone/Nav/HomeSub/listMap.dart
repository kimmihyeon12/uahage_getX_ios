          ...
          widget.placeCode == 1
              ? GestureDetector(
                  ...
                  child: Container(
                    ...
                    margin: EdgeInsets.fromLTRB(51.w * 0.7 * 0.75,
                        100.h * 0.62 * 0.9, 51.w * 0.7 * 0.75, 0),
                    height: 196.h * 0.62 * 0.9,
                    child: Row(
                      // crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Container(
                          margin: EdgeInsets.only(left: 53.w * 0.7 * 0.75),
                          child: Image.asset(
                            "./assets/searchPage/arrow.png",
                            height: 68.h * 0.62 * 0.9,
                          ),
                        ),
                        Container(
                          margin: EdgeInsets.only(left: 41.w * 0.7 * 0.75),
                          width: 1200.w * 0.7 * 0.75,
                          child: // 검색 조건을 설정해주세요
                              Row(
